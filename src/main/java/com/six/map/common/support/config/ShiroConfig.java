...
import com.six.map.common.support.shiro.listener.UserSessionListener;
import com.six.map.common.support.shiro.session.UserSessionDAO;
import com.six.map.common.support.shiro.session.UserSessionFactory;
import com.six.map.modules.sys.shiro.ShiroPermsFilterFactoryBean;
import com.six.map.modules.sys.shiro.UserFilter;
import com.six.map.modules.sys.shiro.UserPermFilter;
import com.six.map.modules.sys.shiro.UserRealm;
...
public class ShiroConfig {
    ...
    public Map<String, String> setInitChainMap() {
        ...
        filterMap.put("/sports-info/register", "anon");
        filterMap.put("/sports-info/football**","anon");
        filterMap.put("/apiV1/footballLeague/**","anon");
